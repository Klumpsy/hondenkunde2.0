  ...
  <div className="block h-[640px] overflow-hidden">
    <div className="flex flex-col h-full bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <p className="mb-3 text-sm text-gray-700 dark:text-gray-400 flex-grow overflow-y-auto" dangerouslySetInnerHTML={{ __html: (ratingItem.explanationText.length > 200 ? ratingItem.explanationText.substring(0, 200) + "..." : ratingItem.explanationText) }}/>

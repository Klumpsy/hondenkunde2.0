...
const FeaturedRating = async ({ratingItem}) => {
    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 py-4">
                ...
                <div className="text-gray-700 text-base" dangerouslySetInnerHTML={{ __html: (ratingItem.explanationText.length > 300 ? ratingItem.explanationText.substring(0, 300) + "..." : ratingItem.explanationText) }}/>
            </div>
            <div className="px-6 pt-4 pb-2">
            <div className="flex space-x-2">
              {ratingItem.tags && ratingItem.tags.map(tag => (
                  <p key={tag + ratingItem.id} 
